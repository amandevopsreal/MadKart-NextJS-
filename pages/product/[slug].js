...
const Post = () => {
    ...
    const [servive,setService]=useState()
    const checkServiceabilty=async()=>{
        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-16 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/61FxrqB7AOL._SY879_.jpg" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className='pin flex mt-6 space-x-2 text-sm'>
                            ...
                            <button onClick={checkServiceabilty} className="flex ml-14 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Check</button>
                        </div>
                        {!servive&&servive!==null&&<div className='text-red-700 text-sm mt-3'>
                            Sorry! We do not deliver to this pincode yet
                        </div>}
                        {servive&&servive!==null&&<div className='text-green-700 text-sm mt-3'>
